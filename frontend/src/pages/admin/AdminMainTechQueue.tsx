                                        ...
                                        <div key={complaint.id} className="bg-white border-b border-gray-200 p-4 last:border-b-0 hover:bg-gray-50 transition-colors">
                                            <div className="flex justify-between items-start mb-3">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="font-medium text-gray-900 text-sm">{complaint.report_number || `ADU-${complaint.id}`}</div>
                                                        <div className="text-[10px] text-gray-500 mt-0.5">{formatDate(complaint.created_at)}</div>
                                                    </div>
                                                </div>
                                                <Link
                                                    to={`/admin/complaint/${complaint.report_number}`}
                                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-[10px] font-medium rounded transition-colors shadow-sm"
                                                >
                                            ...
                                            <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-2 text-sm mt-2">
                                                <span className="text-gray-500 text-xs">Pelanggan</span>
                                                <div className="text-gray-900 font-medium text-xs">
                                                    {complaint.users?.full_name || '-'}
                                                    <div className="text-[10px] text-gray-500 truncate max-w-[200px]" title={complaint.users?.address}>
                                                        {complaint.users?.address || '-'}
                                                    </div>
                                                </div>

                                                <span className="text-gray-500 text-xs">Juruteknik</span>
                                                <div>
                                                ...
                                                <span className="text-gray-500 text-xs">Jarak</span>
                                            ...
                                            <div className="mt-3 pt-3 border-t border-gray-100">
                                                <span className="text-gray-500 text-[10px] uppercase block mb-1">Sebab / Butiran</span>
