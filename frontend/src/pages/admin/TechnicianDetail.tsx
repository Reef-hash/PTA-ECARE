                                ...
                                {filteredList.map((complaint) => (
                                    <div key={complaint.id} className="bg-white border-b border-gray-200 p-4 last:border-b-0 hover:bg-gray-50 transition-colors">
                                        <div className="flex justify-between items-start mb-2">
                                            <div className="flex items-center gap-2">
                                                <span className="font-medium text-indigo-600 text-sm">{complaint.report_number}</span>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1 text-sm items-center">
                                            <span className="text-gray-500 text-[11px] uppercase tracking-wider">{t('admin_users.customer')}</span>
                                            ...
                                            <span className="text-gray-700 text-xs">{complaint.brand_name}</span>
